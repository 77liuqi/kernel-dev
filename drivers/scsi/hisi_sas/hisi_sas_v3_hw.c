...
static int hw_init_v3_hw(struct hisi_hba *hisi_hba)
{
	...
	/* This DSM handle some hardware-related configurations
	 * 1.Switch over to MSI handling , from PCI AER default
				       ...
				       u32 *cache)
{
	...
	if (val != 0xffffffff) {
		dev_err(dev, "Issue occur when reading IOST/ITCT cache!\n");
		return;
	}
